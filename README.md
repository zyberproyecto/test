# Test de APIs – Proyecto Zyber

Este repositorio contiene las colecciones para testear las APIs del proyecto.

## Versión v1.0
Estos tests corresponden a la **primera versión estable (`v1.0`)**, la misma que está tagueada en los repositorios principales:
...
- `api-cooperativa-v1.json` → Requests básicos de comprobantes y horas.  
